...
public abstract class ArrayShow {
     ...
     * @return 
     */
    public static String exec(BitSet array, int n, int separator, String name){
        String result = name + "\n";
        for(int i=0; i<n; i++){
     ...
     * @return 
     */
    public static String exec(BitSet array, int separator){
        String result = "";
     ...
     * @return 
     */
    public static String exec (BitSet array){
        String result = "";
